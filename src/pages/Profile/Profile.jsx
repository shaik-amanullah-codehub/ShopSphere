              ...
              {selectedOrder && (
                <div className="modal-body">
                  ...
                  <div className="card bg-light p-3 mb-3 border-0">
                    <p className="mb-1">
                      <strong>{selectedOrder.shippingAddress?.fullName || selectedOrder.shippingAddress?.name || 'Unknown Recipient'}</strong>
                    </p>
                    <p className="mb-1">
                      {selectedOrder.shippingAddress?.address || selectedOrder.shippingAddress?.line1 || 'Address not available'}
                    </p>
                    <p className="mb-1">
