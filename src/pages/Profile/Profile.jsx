      ...
      <div className="container">
        ...
        <div className="row g-4 mb-4">
          <div className="col-md-4">
            <div className="card stat-card shadow-sm border-0 text-center">
              <div className="card-body p-4">
                <ShoppingBag className="text-primary mb-3 mx-auto d-block" size={32} />
          ...
          <div className="col-md-4">
            <div className="card stat-card shadow-sm border-0 text-center">
              <div className="card-body p-4">
                <DollarSign className="text-success mb-3 mx-auto d-block" size={32} />
        ...
        <div className="card shadow-sm border-0 mb-4 loyalty-card">
          <div className="card-body p-4">
            ...
            <div className="row">
              <div className="col-md-8">
                <p className="text-secondary mb-2">Your Loyalty Points: <strong className="text-primary h5">{loyaltyPoints} pts</strong></p>
                ...
                <small className="text-secondary">Next milestone: 500 points</small>
              </div>
              <div className="col-md-4 text-md-end mt-3 mt-md-0">
            ...
            <p className="text-secondary small mb-0">
              <strong>How it works:</strong> Earn 1 loyalty point for every $10 spent. Redeem 100 points for $10 discount on your next purchase!
            </p>
          </div>
        </div>
          ...
          <div className="card-body p-4">
            ...
            {userOrders.length > 0 ? (
                  ...
                  <tbody>
                    {userOrders.map(order => (
                      <tr key={order.id} className="align-middle">
                        ...
                        <td>
                          <small className="text-secondary">{order.trackingStatus}</small>
                        </td>
                        <td>
                          <button
              ...
              <div className="text-center py-5">
                <ShoppingBag size={48} className="text-secondary mb-3 opacity-50 d-block mx-auto" />
                <p className="text-secondary mb-3">You haven't placed any orders yet</p>
                <button
